...
So, we have seen that balance plays an important role in training such models but tweaking the balance with care can make the training more efficient.

In future more emojis can be included to the model and eventually built into a predictive keyboard to make use of it!
